...
Rscript ~/git/mortality/USA/state/prog/additional_deaths/additional_deaths_all_cardio_stacked_climate_draws_plot_data_cod_1var_2.R $start $end $country 11 $dname $metric $contig $draws
