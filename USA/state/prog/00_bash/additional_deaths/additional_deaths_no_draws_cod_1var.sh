...
Rscript ~/git/mortality/USA/state/prog/additional_deaths/additional_deaths_all_injuries_stacked_climate_cod_1var.R $start $end $country $model $dname $metric $contig $draws;
