...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_contig.pdf'),paper='a4r',height=0,width=0)
p1 = ggplot() +
    ...
    # geom_errorbar(data=subset(additional.deaths.summary,sex>0&age<99&cause!='Other unintentional injuries'),aes(x=as.factor(age.long),ymax=deaths.added.ul,ymin=deaths.added.ll),width=.3,size=0.5) +
    ...
    facet_grid(.~sex.long) +
    scale_fill_manual(values=colors.broad.cod[c(3)]) +
...
p2 =ggplot() +
    ...
    # geom_errorbar(data=subset(additional.deaths.summary.monthly,sex>0&month<99&cause!='Other unintentional injuries'),aes(x=as.factor(month.short),ymax=deaths.added.ul,ymin=deaths.added.ll),width=.3,size=0.5) +
    geom_hline(yintercept=0,linetype='dotted') +
...
p3 = ggplot() +
    ...
    # ylim(c(min.plot,max.plot)) +
    facet_grid(. ~sex.long) +
    scale_fill_manual(values=colors.broad.cod[c(3)],guide=FALSE) +
    # scale_y_continuous(breaks = seq(min.plot, max.plot, by = 50),limits=c(min.plot,max.plot)) +
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_all_contig.pdf'),paper='a4r',height=0,width=0)
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_all_contig_month_skip.pdf'),paper='a4r',height=0,width=0)
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_one_panel_excess_risk_fast_contig.pdf'),paper='a4r',height=0,width=0)
ggplot() +
    ...
    # ylim(c(min.plot,max.plot)) +
    facet_grid(~sex.long) +
    scale_y_continuous(limits=c(-0.02,0.02), labels=scales::percent_format(accuracy=1)) +
    scale_color_manual(values=colors.broad.cod[c(3)]) +
    # scale_y_continuous(breaks = seq(min.plot, max.plot, by = 50),limits=c(min.plot,max.plot)) +
    guides(color=guide_legend(title="",nrow=1)) +
    coord_flip() +
    # ggtitle('Additional deaths by types of intentional injuries') +
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_excess_risk_freescale_fast_contig.pdf'),paper='a4r',height=0,width=0)
ggplot() +
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_monthly_excess_risk_fast_contig.pdf'),paper='a4r',height=0,width=0)
ggplot() +
    # geom_bar(data=subset(additional.deaths.summary.perc,sex>0&age<99&!(cause%in%c('5. Assault','6. Intentional\nself-harm'))), aes(x=as.factor(age.long),y=perc.mean,fill=cause), stat='identity') +
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_monthly_excess_risk_freescale_fast_contig.pdf'),paper='a4r',height=0,width=0)
ggplot() +
    # geom_bar(data=subset(additional.deaths.summary.perc,sex>0&age<99&!(cause%in%c('5. Assault','6. Intentional\nself-harm'))), aes(x=as.factor(age.long),y=perc.mean,fill=cause), stat='identity') +
...
pdf(paste0(file.loc,country,'_rate_pred_type',model,
    '_',year.start,'_',year.end,'_',dname,'_',metric,'_cancer_monthly_one_panel_excess_risk_fast_contig.pdf'),paper='a4r',height=0,width=0)
ggplot() +
