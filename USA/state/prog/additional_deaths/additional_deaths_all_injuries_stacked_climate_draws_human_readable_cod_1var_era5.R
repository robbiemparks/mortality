...
additional.deaths.summary.print = additional.deaths.summary[,c('age.long','sex.long','cause','deaths.added.two.deg.mean','deaths.added.two.deg.ll','deaths.added.two.deg.ul')]
...
additional.deaths.sex.together = ddply(additional.deaths,.(cause,age,draw),summarize,deaths.added=sum(deaths.added.two.deg))
...
additional.deaths.wo.other.intent = ddply(additional.deaths.wo.other,.(intent,sex,age,draw),summarize,deaths.added=sum(deaths.added.two.deg))
...
additional.deaths.wo.other.intent.sex.together = ddply(additional.deaths.wo.other,.(intent,age,draw),summarize,deaths.added=sum(deaths.added.two.deg))
...
# 5. total deaths
additional.deaths.wo.other.total = ddply(additional.deaths.wo.other,.(sex,age,draw),summarize,deaths.added=sum(deaths.added.two.deg))
...
additional.deaths.wo.other.total.sex.together = ddply(additional.deaths.wo.other,.(age,draw),summarize,deaths.added=sum(deaths.added.two.deg))
...
# 1. sub-categories of deaths
additional.deaths.summary.monthly.print = additional.deaths.summary.monthly[,c('month.short','sex.long','cause','deaths.added.two.deg.mean','deaths.added.two.deg.ll','deaths.added.two.deg.ul')]
...
additional.deaths.summary.perc$cause = factor(additional.deaths.summary.perc$cause, levels=c('Transport','Falls','Drownings','Assault','Intentional self-harm'))
...
additional.deaths.summary.monthly.perc$cause = factor(additional.deaths.summary.monthly.perc$cause, levels=c('Transport','Falls','Drownings','Assault','Intentional\nself-harm'))
