...
inla.function.climate.2var <- function(age.sel,sex.sel,year.start,year.end,type,cluster,cause='Allcause') {
...
inla.function.climate.2var.fast <- function(age.sel,sex.sel,year.start,year.end,type,cluster,cause='Allcause') {
