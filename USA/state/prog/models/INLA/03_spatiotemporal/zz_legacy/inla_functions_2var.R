...
inla.function.climate.2var <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
    ...
    file.loc <- paste0('~/data/mortality/US/state/climate_effects/',dname.arg,'/2var/',metric.arg,'/non_pw/type_',type.selected,'/age_groups/',age.sel)
...
inla.function.climate.2var.fast <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
...
inla.function.climate.2var.faster <- function(age.sel,sex.sel,year.start,year.end,type,cluster) {
